...
import {QueryDto, QueryRequestType, QuerySearchType, QuerySortType} from '../../common/types';
...
export class GetAllUsersQuery {
    ...
    constructor(query: QueryRequestType) {
        ...
        if (query.searchLoginTerm) this.searchData.searchLoginTerm = query.searchLoginTerm;
        if (query.searchEmailTerm) this.searchData.searchEmailTerm = query.searchEmailTerm;
        if (query.searchNameTerm) this.searchData.searchNameTerm = query.searchNameTerm;
    }
}
